...
export const CommentForm = () => {
  ...
  const { mutateAsync: createCommentMutation, isLoading } = useMutationCreateComment();
  ...
  if (isLoading)
    return (
      <div className="flex h-screen mx-auto px-16 py-10 ">
        <Loader />
      </div>
    );
  ...
  return (
    ...
    >
      <div className="flex flex-col w-full">
        ...
        />
        <p className="my-2 text-sm font-bold text-red-500">{errors.title?.message}</p>
        <label htmlFor="title" className="text-mg font-bold text-gray-900">
          Treść
        </label>
        <input
          ...
          className="my-2 p-2 h-10 border-2 border-gray-100 w-full rounded-lg focus:outline-none"
        />
        <p className="my-2 text-sm font-bold text-red-500">{errors.message?.message}</p>
        <label htmlFor="title" className="text-mg font-bold text-gray-900">
          Data
        </label>
        <input
          ...
          className="my-2 p-2 h-10 border-2 border-gray-100 w-full rounded-lg focus:outline-none"
        />
        <p className="my-2 text-sm font-bold text-red-500">{errors.date?.message}</p>
        <label htmlFor="title" className="text-mg font-bold text-gray-900">
          Autor
        </label>
        <input
          ...
          className="my-2 p-2 h-10 border-2 border-gray-100 w-full rounded-lg focus:outline-none"
        />
        <p className="my-2 text-sm font-bold text-red-500">{errors.author?.message}</p>
        <label htmlFor="title" className="text-mg font-bold text-gray-900">
          Typ
        </label>
        <select
        ...
        <p className="my-2 text-sm font-bold text-red-500">{errors.type?.message}</p>
      </div>
      <button
        disabled={!isValid}
        type="submit"
